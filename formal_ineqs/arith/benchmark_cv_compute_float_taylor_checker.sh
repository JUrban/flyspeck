...
#use "$flyspeck_root/formal_ineqs/arith/benchmark_cv_compute_float_taylor_checker.hl";;
EOF
)
...
for marker in \
  ...
  CANDLE_CV_TAYLOR_CHECKER_CELLS=32 \
  CANDLE_CV_TAYLOR_CHECKER_LARGE_TICKS= \
  CANDLE_CV_TAYLOR_CHECKER_LARGE_CELLS=128 \
  CANDLE_CV_TAYLOR_CHECKER_BENCHMARK_OK
do
...
rg -o 'CANDLE_CV_TAYLOR_CHECKER_[A-Z_]+=[0-9]+' "$log_file"
printf '%s\n' 'CANDLE_CV_TAYLOR_CHECKER_BENCHMARK_OK'
